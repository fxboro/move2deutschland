    ...
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-400 pt-16 pb-8 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-12 border-b border-slate-800 relative z-10">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <p className="text-slate-300 text-base leading-relaxed max-w-sm">
            Empowering African and Nigerian candidates to transition to
            tuition-free education and high-paying careers in Germany. The
            smart, reliable pathway to Europe.
          </p>
          <div className="flex gap-4">
            <a
              href="#"
              className="w-10 h-10 rounded-full bg-slate-800 hover:bg-gold hover:text-prussian-blue flex items-center justify-center text-slate-300 transition-all duration-300"
              aria-label="Facebook"
            >
              <Facebook size={18} />
            </a>
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          <h3 className="font-heading font-bold text-white text-lg tracking-wider uppercase">
            Routes
          </h3>
          <ul className="flex flex-col gap-3">
            <li>
              <Link
                to="/programs"
                className="hover:text-gold transition-colors duration-200 text-sm"
              >
                Study Route
              </Link>
            </li>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm text-slate-400">
              Get the latest intake deadlines, blocked account updates, and visa
              guidance.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500 relative z-10">
        <p className="flex flex-wrap items-center gap-x-6 gap-y-2">
          <span>
            © {currentYear} Move2Deutschland operating under Buytripsnow OÜ All
