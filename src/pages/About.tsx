...
import { Target, Eye, Heart, Users, GraduationCap, Clock, UsersRound, Quote } from 'lucide-react';
...
const stats = [
  ...
  { label: 'Partner Universities', value: 40, suffix: '+', icon: GraduationCap },
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 bg-prussian-blue text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          >
            We're on a mission to dismantle barriers and open Germany's doors to ambitious
            African professionals and students — one success story at a time.
          </motion.p>
        </div>
      </section>
            ...
            >
              ...
              <div className="space-y-4 text-slate-650 dark:text-slate-300 leading-relaxed">
                ...
                <p>
                  ...
                  and start new lives in Germany — all with the insider knowledge that only comes
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-slate-400 text-base max-w-xl mx-auto">
              Every number represents a life changed, a barrier broken, and a dream realized.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-6 md:px-12 bg-prussian-blue relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Ready to Start Your<br className="hidden sm:block" /> Journey to Germany?
          </motion.h2>
          ...
          >
            Take our free 2-minute eligibility quiz and discover the best pathway to tuition-free
            education or a skilled-worker visa in Germany.
          </motion.p>
          ...
          >
            <Link to="/#questionnaire">
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 0 40px rgba(255,204,0,0.5)' }}
                whileTap={{ scale: 0.95 }}
          ...
          >
            Trusted by <span className="text-gold font-semibold">500+</span> students across Nigeria, Ghana, Kenya & beyond.
          </motion.p>
        </div>
      </section>
