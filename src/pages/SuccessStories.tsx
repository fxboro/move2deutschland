...
const stories: Story[] = [
  {
    ...
    rating: 5,
    quote:
      "Move2Deutschland made my dream of studying in Germany a reality. From document preparation to university admission, they held my hand through every step. I'm now thriving at TUM and loving life in Munich.",
  },
  {
    id: 2,
    name: "Chinedu Amadi",
    photo:
      "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?auto=format&fit=crop&w=400&h=400&q=80",
    route: "Abuja → Berlin",
    ...
    rating: 5,
    quote:
      "I was skeptical at first, but the team's professionalism won me over. They helped me navigate the blocked account, visa interview prep, and even finding accommodation in Berlin. Worth every naira.",
  },
  {
    id: 3,
    name: "Folake Adeyemi",
    ...
    rating: 5,
    quote:
      "As a female engineer, I wanted a university with world-class labs. Move2Deutschland matched me with RWTH Aachen, and the support with my scholarship application was incredible. I received a DAAD scholarship!",
  },
  {
    id: 4,
    name: "Emeka Nwosu",
    ...
    rating: 5,
    quote:
      "The Opportunity Card route was perfect for me. With 6 years of experience, I didn't need another degree. The team helped me score 8 points on the Chancenkarte system and I landed a job at Bosch within 3 months of arriving.",
  },
  {
    id: 5,
    name: "Ngozi Eze",
    ...
    rating: 5,
    quote:
      "Heidelberg University was my first choice and Move2Deutschland helped me craft an application that stood out. The German course recommendations they gave me helped me pass my TestDaF with flying colours.",
  },
  {
    id: 6,
    ...
    rating: 5,
    quote:
      "I never thought moving to Germany without a job offer was possible until I heard about the Chancenkarte. The Move2Deutschland team walked me through the points system, helped with my CV in German format, and connected me with recruiters.",
  },
  {
    id: 7,
    name: "Amina Yusuf",
    ...
    rating: 5,
    quote:
      "From the very first consultation call, I knew I was in good hands. They explained everything — uni-assist, Anabin, APS — in a way that finally made sense. Hamburg is now my home and I couldn't be happier.",
  },
  {
    id: 8,
    name: "Tunde Ogundimu",
    ...
    rating: 5,
    quote:
      "Dresden is an underrated gem and Move2Deutschland knew that. They recommended TU Dresden for my profile and it was the perfect fit — great research facilities, low cost of living, and a welcoming international community.",
  },
];

type FilterType =
  "All" | "Study Route" | "Opportunity Card" | "2024" | "2023" | "2022";
...
function StoryCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 flex flex-col group transition-all duration-300 cursor-default"
    >
      {/* Profile & Info Header */}
      <div className="flex items-start gap-4 mb-5">
        ...
        <div className="min-w-0">
          <h3 className="font-heading text-lg font-bold text-prussian-blue truncate">
            {story.name}
          </h3>
      ...
      <div className="space-y-2 mb-5">
        <div className="flex items-center gap-2 text-sm text-slate-600 ">
          <GraduationCap
            size={15}
            className="text-prussian-blue flex-shrink-0"
          />
...
export default function SuccessStories() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Read real success stories of Nigerian students and professionals who successfully relocated to Germany using Move2Deutschland.",
      );
    }
  }, []);
  ...
  const filteredStories = stories.filter((story) => {
    ...
    if (activeFilter === "Opportunity Card")
      return story.category === "opportunity-card";
    // Year filters
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-12">
              Nothing speaks louder than the voices of those who've walked the
              path before you.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gold/90 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 mb-6">
                <Play
                  size={36}
                  className="text-prussian-blue ml-1"
                  fill="currentColor"
                />
              </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              Your Success Story <span className="text-gold">Starts Here</span>
            </h2>
            <p className="text-slate-300 text-lg mb-10 max-w-xl mx-auto">
              Join hundreds of Nigerian students and professionals who have
              successfully relocated to Germany with our guidance.
            </p>
            <Link to="/">
              <motion.button
