...
export default function Auth() {
  ...
  useEffect(() => {
    if (isForgotPassword) {
      ...
      document.title = isLogin
        ? "Sign In | Move2Deutschland"
        : "Create Account | Move2Deutschland";
    }
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Access the Move2Deutschland portal to complete your relocation application and track document status.",
      );
    }
  ...
  return (
    <div className="min-h-screen flex font-sans relative overflow-hidden bg-slate-900">
      ...
      <div className="hidden lg:flex w-1/2 relative z-20 flex-col justify-between p-16">
        ...
        <div className="max-w-xl">
          ...
          <p className="text-slate-200 text-lg leading-relaxed mb-8 drop-shadow-sm">
            Join hundreds of Nigerian students who have successfully relocated
            to Germany. Track your application, manage documents, and prepare
            for your visa all in one place.
          </p>
          ...
          <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 shadow-lg">
            <div className="flex -space-x-3 overflow-hidden">
              <img
                className="inline-block h-10 w-10 rounded-full ring-2 ring-prussian-blue object-cover"
            ...
            <div>
              <p className="text-sm font-bold text-white">
                Join 500+ Nigerian students
              </p>
              <p className="text-xs text-slate-300">
                Already on their relocation journey
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-slate-400 text-xs">
          © {new Date().getFullYear()} Move2Deutschland operating under
          Buytripsnow OÜ All rights reserved. Built by{" "}
          <a
      ...
      {/* Right side - Form */}
      <div className="w-full lg:w-1/2 flex flex-col lg:flex-row items-center justify-center p-6 sm:p-12 md:p-16 relative z-25 bg-white/95 backdrop-blur-2xl shadow-2xl transition-colors duration-300">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-between items-center mb-8">
            <Link
              to="/"
              className="inline-flex items-center text-sm font-bold text-slate-500 hover:text-prussian-blue transition-colors"
            >
          ...
          <div className="lg:hidden flex items-center gap-3 bg-slate-50 border border-slate-200/60 rounded-2xl p-3.5 mb-6">
            ...
            <div>
              <p className="text-xs font-extrabold text-prussian-blue ">
                Join 500+ Nigerian students
              </p>
          ...
          <div className="mb-10">
            <h1 className="font-heading text-3xl md:text-4xl font-extrabold text-prussian-blue mb-2">
              {isForgotPassword
                ? "Reset password"
                : isLogin
                  ? "Welcome back"
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    {isLogin && (
                      <button
                        ...
                        className="text-sm font-bold text-prussian-blue hover:underline cursor-pointer"
                      >
                        Forgot password?
                      </button>
                    )}
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-10 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 focus:border-prussian-blue focus:ring-2 focus:ring-prussian-blue/20 outline-none transition-all"
                      placeholder="••••••••"
                    />
                    <div
                      role="button"
                ...
                <AnimatePresence mode="popLayout">
                  {!isLogin && (
                    ...
                    >
                      ...
                      <label
                        htmlFor="terms"
                        className="ml-2.5 text-sm font-semibold text-slate-600 cursor-pointer"
                      >
                        I agree to the{" "}
                        <Link
                          to="/terms"
          ...
          {!isForgotPassword && (
            <>
              ...
              <button
                ...
                className="mt-6 w-full bg-white border border-slate-200 text-slate-700 font-bold py-3.5 px-4 rounded-xl hover:bg-slate-50 shadow-sm hover:shadow transition-all flex items-center justify-center cursor-pointer"
              >
            ...
            <div className="mt-8 text-center">
              <p className="text-slate-500 text-sm">
                ...
                <button
                  ...
                  className="font-bold text-prussian-blue hover:underline focus:outline-none cursor-pointer"
                >
