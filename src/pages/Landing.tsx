...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Move2Deutschland helps Nigerian students and skilled workers relocate to Germany through tuition-free university admission and point-based Opportunity Card pathways.",
      );
    }
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans relative overflow-hidden transition-colors duration-300">
        ...
        {hasDraft && (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-gold/20 flex items-center justify-center font-bold text-sm shrink-0">
                💡
              </div>
      ...
      {/* Hero Section */}
      <section className="relative text-white pt-28 sm:pt-20 pb-24 sm:pb-40 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          >
            Your Global Leap Starts in Germany.{" "}
          ...
          >
            <strong>Stop dreaming</strong>, start planning your career. Move to
            Europe's economic powerhouse via tuition-free study or point based
            opportunity card for skilled workers routes.
          </motion.p>
      ...
      <section
        id="questionnaire"
        className="relative -mt-20 sm:-mt-32 z-20 px-6 md:px-12 max-w-3xl mx-auto"
      >
        <LeadQuestionnaire />
      </section>
      ...
      <section
        id="why-germany"
        className="py-24 px-6 md:px-12 max-w-7xl mx-auto mt-12"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            whileHover={{
              y: -8,
              boxShadow:
                "0 20px 25px -5px rgba(0, 49, 83, 0.08), 0 0 0 2px rgba(0, 49, 83, 0.05)",
            }}
          ...
          >
            ...
            <h3 className="font-heading text-2xl font-bold text-prussian-blue mb-4">
              Zero-Tuition
            </h3>
            <p className="text-slate-600 leading-relaxed text-sm">
              Public universities in Germany charge €0 tuition. Invest your
              money in your life, not just a degree.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Germany gives you 1.5 years to find a professional role after
              graduation, ensuring a smooth career start.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Germany is looking for its next generation of engineers, IT
              experts, and healthcare leaders to fill talent gaps.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Germany offers a pathway to citizenship in 5 years—what an
              opportunity to contribute and hold a top-tier passport.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="hidden sm:block bg-white rounded-2xl overflow-hidden shadow-2xl text-slate-800">
            <div className="grid grid-cols-3 border-b border-slate-200">
              <div className="p-4 md:p-6 bg-slate-50 font-heading font-bold text-sm md:text-lg flex items-center justify-center text-center">
                Feature
              </div>
              <div className="p-4 md:p-6 bg-slate-100 font-heading font-bold text-sm md:text-lg text-center border-l border-slate-200">
                UK / USA
                <br />
              ...
              <div className="p-4 md:p-6 bg-gold/10 font-heading font-bold text-sm md:text-lg text-center border-l border-slate-200 text-prussian-blue">
                Germany
                <br />
                <span className="text-xs md:text-sm text-green-600 font-normal">
                  High Stability
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 border-b border-slate-100 relative hover:bg-blue-50 hover:shadow-md hover:scale-[1.02] hover:z-10 transition-all duration-300 cursor-pointer">
              <div className="p-4 md:p-6 font-medium flex items-center text-sm md:text-base">
                Tuition Fees
              </div>
              <div className="p-4 md:p-6 border-l border-slate-100 flex items-center justify-center text-center text-red-650 font-semibold text-sm md:text-base">
                £15k - $40k / year
              </div>
              <div className="p-4 md:p-6 border-l border-slate-100 bg-gold/5 flex items-center justify-center text-center text-green-600 font-bold text-lg md:text-xl">
                €0
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 border-b border-slate-100 relative hover:bg-blue-50 hover:shadow-md hover:scale-[1.02] hover:z-10 transition-all duration-300 cursor-pointer">
              ...
              <div className="p-4 md:p-6 border-l border-slate-100 flex items-center justify-center text-center text-slate-600 text-sm md:text-base">
                Strict / Expensive
              </div>
              <div className="p-4 md:p-6 border-l border-slate-100 bg-gold/5 flex items-center justify-center text-center text-prussian-blue font-semibold text-sm md:text-base">
            ...
            <div className="grid grid-cols-3 border-b border-slate-100 relative hover:bg-blue-50 hover:shadow-md hover:scale-[1.02] hover:z-10 transition-all duration-300 cursor-pointer">
              ...
              <div className="p-4 md:p-6 border-l border-slate-100 flex items-center justify-center text-center text-slate-650 text-sm md:text-base">
                Saturated
              </div>
              <div className="p-4 md:p-6 border-l border-slate-100 bg-gold/5 flex items-center justify-center text-center text-prussian-blue font-semibold text-sm md:text-base">
                700k+ Openings
            ...
            <div className="grid grid-cols-3 relative hover:bg-blue-50 hover:shadow-md hover:scale-[1.02] hover:z-10 transition-all duration-300 cursor-pointer">
              ...
              <div className="p-4 md:p-6 border-l border-slate-100 flex items-center justify-center text-center text-red-600 font-medium text-sm md:text-base">
                Complex & Uncertain
              </div>
              <div className="p-4 md:p-6 border-l border-slate-100 bg-gold/5 flex items-center justify-center text-center text-green-600 font-bold text-sm md:text-base">
                Clear & Structured
              </div>
            </div>
          </div>
          ...
          <div className="sm:hidden space-y-6 text-slate-800">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
              <h3 className="font-heading font-bold text-lg text-prussian-blue mb-4 border-b border-slate-100 pb-2">
                Tuition Fees
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gold/10 p-3 rounded-xl text-center border border-gold/20">
                  ...
                  <p className="text-xs font-bold text-prussian-blue mt-1">
                    18 Mths Guar.
                  </p>
                </div>
              </div>
      ...
      <section className="py-24 px-6 md:px-12 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              We don't just process applications; we engineer your success story
              in Germany.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              whileHover={{
                y: -8,
                boxShadow:
                  "0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 0 0 2px rgba(255, 204, 0, 0.2)",
              }}
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Navigate the complex German university system and visa process
                with consultants who have successfully done it themselves.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                From university selection to finding accommodation and opening
                your blocked account, we are with you at every step.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Join hundreds of Nigerian students who have successfully
                transitioned to tuition-free education and thriving careers in
                Germany.
              </p>
            </motion.div>
          </div>
