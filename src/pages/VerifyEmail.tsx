...
export default function VerifyEmail() {
  ...
  return (
    <div 
      className="min-h-screen flex items-center justify-center font-sans relative bg-cover bg-center p-6"
      ...
      >
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full bg-prussian-blue text-white font-bold py-4 px-6 rounded-xl hover:bg-prussian-blue/90 shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
        ...
        <div className="mt-10 pt-8 border-t border-slate-200/50 flex flex-col gap-4">
          <button 
            ...
            className="text-sm font-bold text-slate-500 hover:text-prussian-blue flex items-center justify-center gap-2 transition-colors"
          >
            <LogOut size={16} />
