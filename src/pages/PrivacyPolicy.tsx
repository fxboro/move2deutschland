          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-slate-100 prose prose-slate max-w-none">
              ...
              <section id="data-collection" className="scroll-mt-36 mb-12">
                ...
                <h3 className="text-lg font-bold text-prussian-blue mb-2">A. Information You Provide</h3>
                ...
                <h3 className="text-lg font-bold text-prussian-blue mb-2">B. Information Automatically Collected</h3>
                <p className="text-slate-600 leading-relaxed">
