    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 bg-prussian-blue text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center px-6 md:px-12 relative z-10">
          ...
          >
            Two proven routes to build your career in Europe's economic powerhouse.
          </motion.p>
        </div>
      </section>
              ...
              <div className="bg-prussian-blue rounded-2xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg md:text-xl leading-relaxed mb-8 italic">
                    "Move2Deutschland made the impossible feel easy. From finding
                    the right university to setting up my blocked account — they
                    were there every step of the way. I'm now studying Computer
                    Science in Munich, tuition-free!"
                  </p>
